...
<head>
    @section('head')
        ...
        <meta name="author" content="duck. @ theBIGGAME">
...
<div class="site-wrapper">
    <nav class="navbar fixed-bottom navbar-expand-md navbar-inverse bg-dark">
        ...
        <div class="collapse navbar-collapse mr-auto mt-2 mt-lg-0" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link interna-font" href="/interna">
                        internastream
                    </a>
                </li>
            </ul>
    ...
    @section('footer')
        <div class="footer text-center">
            &copy; theBIGGAME {{date('Y')}} &centerdot; streamnet by <a href="http://twitter.com/duckfullstop">@duckfullstop</a>
        </div>
    @show
</div>
</body>
